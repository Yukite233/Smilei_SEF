...
#ifndef COLLISIONS_CHARGEEXCHANGE_H
#define COLLISIONS_CHARGEEXCHANGE_H
...
class Collisions_ChargeExchange : public Collisions
{

public:
    //! Constructor for Collisions between two species
    Collisions_ChargeExchange(PicParams&,std::vector<Species*>&,SmileiMPI*,unsigned int,std::vector<unsigned int>,std::vector<unsigned int>,double,bool,int);
    ~Collisions_ChargeExchange();
