...
# coulomb_log = float, DSMC logarithm. If negative or zero, then automatically computed.
Collisions(
	species1 = ["ion1"],
	species2 = ["electron1"],
	coulomb_log = 2.0
...
#ifndef COLLISIONS_DSMC_H
#define COLLISIONS_DSMC_H
...
class Collisions_DSMC : public Collisions
{

public:
    //! Constructor for Collisions between two species
    Collisions_DSMC(PicParams&,std::vector<Species*>&,SmileiMPI*,unsigned int,std::vector<unsigned int>,std::vector<unsigned int>,double,bool,int);
    ~Collisions_DSMC();
