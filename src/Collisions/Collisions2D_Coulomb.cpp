...
// Constructor
Collisions2D_Coulomb::Collisions2D_Coulomb(PicParams& param, vector<Species*>& vecSpecies, SmileiMPI* smpi,
...
void Collisions2D_Coulomb::calculate_debye_length(PicParams& params, vector<Species*>& vecSpecies)
{
...
void Collisions2D_Coulomb::collide(PicParams& params, vector<Species*>& vecSpecies, int itime)
{
...
inline double Collisions2D_Coulomb::cos_chi(double s)
{
