...
// Constructor
Collisions2D_DSMC::Collisions2D_DSMC(PicParams& param, vector<Species*>& vecSpecies, SmileiMPI* smpi,
...
void Collisions2D_DSMC::collide(PicParams& params, vector<Species*>& vecSpecies, int itime)
{
